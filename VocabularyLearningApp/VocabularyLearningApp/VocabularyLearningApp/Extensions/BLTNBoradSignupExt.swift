//
//  BLTNBoradSignupExt.swift
//  VocabularyLearningApp
//
//  Created by Yusuf Özgül on 28.02.2019.
...
extension BLTNBoradSignup: UITextFieldDelegate
{
...
//      Text edit alert remove
    func textFieldDidBeginEditing(_ textField: UITextField)
    {
        ...
        descriptionText = NSLocalizedString("SIGNUP_DESC", comment: "")
    }
}
